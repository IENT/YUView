...
const char* DefaultRenderer::fragmentShaderCode[] = {
...
const char* DefaultRenderer::vertexShaderCode[] = {
    "void main()",
    "{",
...
DefaultRenderer::DefaultRenderer() : Renderer(), p_shaderProgramHandle(0)
{
}

bool DefaultRenderer::render() const
{
    // don't render into frame buffer object
...
bool DefaultRenderer::deactivate() {
    GLsizei count;
    GLuint shaders[10];
...
void DefaultRenderer::setRenderYUV(bool y, bool u, bool v) {
...
void DefaultRenderer::drawRect() const
{
    glUseProgram(p_shaderProgramHandle);

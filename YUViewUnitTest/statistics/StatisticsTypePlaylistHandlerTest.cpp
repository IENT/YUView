...
QString saveItemAndGetXmlAsText(const StatisticsType &statisticsType)
{
     ...
     SaveStatisticsType_NoOptionsModified_ShouldNotAddTheTypeAtAll)
{
  ...
  EXPECT_EQ(saveItemAndGetXmlAsText(statisticsType), "<playlistItemStatisticsFile/>\n");
}
     ...
     SaveStatisticsType_ValueDataOptionsModified_ShouldAddTypeAndValues)
{
  ...
  EXPECT_EQ(saveItemAndGetXmlAsText(statisticsType),
            ...
            "colorMapperType=\"Predefined\" renderValueData=\"0\" "
            "scaleValueToBlockSize=\"0\">SomeTestType</statType1>\n" //
            "</playlistItemStatisticsFile>\n");
}
     ...
     SaveStatisticsType_VectorDataOptionsModified_ShouldAddTypeAndValues)
{
  ...
  std::cout << saveItemAndGetXmlAsText(statisticsType).toStdString() << std::endl;

  EXPECT_EQ(saveItemAndGetXmlAsText(statisticsType),
            "<playlistItemStatisticsFile>\n"
            " <statType1 mapVectorToColor=\"1\" renderVectorData=\"0\" "
            "renderVectorDataValues=\"0\" renderarrowHead=\"1\" scaleVectorToZoom=\"1\" "
            "vectorScale=\"4\" vectorStyle=\"#80164c 2 3\">SomeTestType</statType1>\n"
            "</playlistItemStatisticsFile>\n");
}

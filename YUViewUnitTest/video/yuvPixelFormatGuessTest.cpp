...
void yuvPixelFormatGuessTest::testFormatGuessFromFilename_data()
{
  ...
  // // Issue 211
  QTest::newRow("testIssue211") << "sample_1280x720_16bit_444_packed_20200109_114812.yuv" << bytes1280 << 1280 << 720 << -1 << 16 << true << "YUV 4:4:4 16-bit LE packed";
  QTest::newRow("testIssue211") << "sample_1280x720_16b_yuv44416le_packed_20200109_114812.yuv" << bytes1280 << 1280 << 720 << -1 << 16 << true << "YUV 4:4:4 16-bit LE packed";
  QTest::newRow("testIssue211") << "sample_1280x720_16b_yuv16le_packed_444_20200109_114812" << bytes1280 << 1280 << 720 << -1 << 16 << true << "YUV 4:4:4 16-bit LE packed";

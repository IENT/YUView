...
StatisticsObject::~StatisticsObject() 
{
  ...
  {
    // We will have to wait for this to finish before deleting the StatisticsObject
    // as the QFuture generated by QtConcurrent::run is not capable of canceling a running thread.
    // For this we will have to use threads I guess. Mayer signals/slots can also be used.
    // THIS WILL BLOCK THE GUI UNTIL PARSING IS DONE.

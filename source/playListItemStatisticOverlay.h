...
#ifndef PLAYLISTITEMSTATISTICOVERLAY_H
#define PLAYLISTITEMSTATISTICOVERLAY_H

#include "playlistItemOverlay.h"

#include "playlistItemStatisticsFile.h"

class PlayListItemStatisticOverlay : public playlistItemOverlay
{
    Q_OBJECT

public:
    // Default-Constructor
    PlayListItemStatisticOverlay();

    // information about the StatisticOverlay
    infoData getInfo() const Q_DECL_OVERRIDE;

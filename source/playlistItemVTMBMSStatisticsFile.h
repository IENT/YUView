...
#ifndef PLAYLISTITEMVTMBMSSTATISTICSFILE_H
#define PLAYLISTITEMVTMBMSSTATISTICSFILE_H
...
class playlistItemVTMBMSStatisticsFile : public playlistItem
{
  Q_OBJECT
...
public:
  ...
  /*
  */
  playlistItemVTMBMSStatisticsFile(const QString &itemNameOrFileName);
  virtual ~playlistItemVTMBMSStatisticsFile();
  ...
  */
  ...
  static playlistItemVTMBMSStatisticsFile *newplaylistItemVTMBMSStatisticsFile(const QDomElementYUView &root, const QString &playlistFilePath);
...
#endif // PLAYLISTITEMVTMBMSSTATISTICSFILE_H

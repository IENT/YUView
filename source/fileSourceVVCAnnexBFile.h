...
#ifndef FILESOURCEVVCANNEXBFILE_H
#define FILESOURCEVVCANNEXBFILE_H
...
class fileSourceVVCAnnexBFile : public fileSourceAnnexBFile
{
  Q_OBJECT

public:
  fileSourceVVCAnnexBFile() : fileSourceAnnexBFile() { firstPOCRandomAccess = INT_MAX; }
  ~fileSourceVVCAnnexBFile() {}
...
protected:
  ...
  */
  ...
  {
    nal_unit_vvc(quint64 filePos, int nal_idx) : nal_unit(filePos, nal_idx), nal_type(UNSPECIFIED) {}
    ...
    virtual int getPOC() const override { return poc; }

 ...
 */
FileInfoDock::FileInfoDock(QWidget *parent) : QDockWidget(parent)
{
  contentWidget = new QWidget(this);
  infoLayout = new QGridLayout;
  contentWidget->setLayout(infoLayout);
...
FileInfoDock::~FileInfoDock()
{
  delete infoLayout;
}

void FileInfoDock::setFileInfo()
{
  // Clear title
  setWindowTitle("Info");
...
void FileInfoDock::setFileInfo(QString fileInfoTitle, QList<infoItem> fileInfoList)
{
  // Set the title
  setWindowTitle(fileInfoTitle);
...
void FileInfoDock::currentSelectedItemsChanged(playlistItem *item1, playlistItem *item2)
{

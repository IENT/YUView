...
QList<infoItem> TextObject::getInfoList()
{
  QList<infoItem> infoList;

  infoList.append(infoItem("Text", p_TextString));
  infoList.append(infoItem("Font Family", p_TextFont.family()));
  ...
  infoList.append(infoItem("Font Size", fontSize));

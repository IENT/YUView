...
void fileSourceVVCAnnexBFile::parseAndAddNALUnit(int nalID)
{
  ...
  auto nal_jem = QSharedPointer<nal_unit_vvc>(new nal_unit_vvc(curFilePos, nalID));
...
void fileSourceVVCAnnexBFile::nal_unit_vvc::parse_nal_unit_header(const QByteArray &parameterSetData, TreeItem *root)
{
...
bool fileSourceVVCAnnexBFile::nal_unit_vvc::isIRAP()
{ 
...
bool fileSourceVVCAnnexBFile::nal_unit_vvc::isSLNR()
{ 
...
bool fileSourceVVCAnnexBFile::nal_unit_vvc::isRADL() {
  return (nal_type == RADL_N || nal_type == RADL_R); 
}

bool fileSourceVVCAnnexBFile::nal_unit_vvc::isRASL()
{ 
  return (nal_type == RASL_N || nal_type == RASL_R); 
}

bool fileSourceVVCAnnexBFile::nal_unit_vvc::isSlice()
{ 
...
QByteArray fileSourceVVCAnnexBFile::nal_unit_vvc::getNALHeader() const
{ 

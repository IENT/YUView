...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SliderDelegate_t, stringdata) + ofs \
...
const QMetaObject SliderDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_SliderDelegate.data,
      qt_meta_data_SliderDelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SliderDelegate.stringdata))
        return static_cast<void*>(const_cast< SliderDelegate*>(this));

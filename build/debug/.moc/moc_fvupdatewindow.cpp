...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FvUpdateWindow_t, stringdata) + ofs \
...
const QMetaObject FvUpdateWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FvUpdateWindow.data,
      qt_meta_data_FvUpdateWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FvUpdateWindow.stringdata))

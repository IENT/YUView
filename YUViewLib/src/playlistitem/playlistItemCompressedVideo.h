...
public:
  ...
  virtual void
  drawItem(QPainter *painter, int frameIdx, double zoomFactor, bool drawRawData) Q_DECL_OVERRIDE;
  ...
  virtual bool isSourceChanged() Q_DECL_OVERRIDE
  { /* TODO */
    return false;
  }
  ...
  virtual void
  loadFrame(int frameIdx, bool playing, bool loadRawData, bool emitSignals = true) Q_DECL_OVERRIDE;

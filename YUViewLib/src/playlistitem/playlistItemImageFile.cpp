...
playlistItemImageFile::playlistItemImageFile(playlistItemImageFile *clone) : playlistItem(clone)
{
  this->initFile();
}

void playlistItemImageFile::initFile()
{
  ...
  // Does the file exits?
  QFileInfo fileInfo(this->prop.name);

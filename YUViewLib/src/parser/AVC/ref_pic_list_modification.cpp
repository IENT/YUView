...
void ref_pic_list_modification::parse(reader::SubByteReaderLogging &reader, SliceType slice_type)
{
  SubByteReaderLoggingSubLevel subLevel(reader, "ref_pic_list_modification()");

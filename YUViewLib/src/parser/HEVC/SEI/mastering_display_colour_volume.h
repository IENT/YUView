...
class mastering_display_colour_volume : public sei_payload
{
public:
  mastering_display_colour_volume() = default;
  ...
  unsigned display_primaries_x[3]{};
  unsigned display_primaries_y[3]{};

...
public:
  ...
  std::vector<int> sps_qp_table_start_minus26 {};
  std::vector<unsigned> sps_num_points_in_qp_table_minus1 {};
  std::vector<std::vector<unsigned>> sps_delta_qp_in_val_minus1 {};
  std::vector<std::vector<unsigned>> sps_delta_qp_diff_val {};
  ...
  std::vector<unsigned> sps_num_ref_pic_lists {};
  ...
  std::vector<int> sps_ladf_qp_offset {};
  std::vector<unsigned> sps_ladf_delta_threshold_minus1 {};
  ...
  std::vector<unsigned> sps_virtual_boundary_pos_x_minus1 {};
  unsigned sps_num_hor_virtual_boundaries {};
  std::vector<unsigned> sps_virtual_boundary_pos_y_minus1 {};
